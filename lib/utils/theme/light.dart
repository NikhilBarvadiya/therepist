...
class AppTheme {
  ...
  static ThemeData lightTheme = ThemeData(
    ...
    textTheme: GoogleFonts.poppinsTextTheme().copyWith(
      ...
      bodySmall: GoogleFonts.poppins(fontSize: 12, fontWeight: FontWeight.normal, color: textLight),
      ...
      labelSmall: GoogleFonts.poppins(fontSize: 11, fontWeight: FontWeight.w500, color: textLight),
    ),
    appBarTheme: AppBarTheme(
      ...
      titleTextStyle: GoogleFonts.poppins(fontSize: 18, fontWeight: FontWeight.w600, color: backgroundWhite),
    ...
    inputDecorationTheme: InputDecorationTheme(
      ...
      labelStyle: GoogleFonts.poppins(fontSize: 14, color: textSecondary, fontWeight: FontWeight.w500),
      hintStyle: GoogleFonts.poppins(fontSize: 14, color: textLight),
      errorStyle: GoogleFonts.poppins(fontSize: 12, color: Color(0xFFEF4444)),
    ),
